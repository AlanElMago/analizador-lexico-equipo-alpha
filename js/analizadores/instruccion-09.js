...
export const instruccion09 = (tokens) => {
    ...
    textoSalida.push(`${tokens[2]}: argumento de la instrucción (${obtenerTipoSimbolo(tokens[2])}). Objeto que se desea convertir en cadena de texto.`);
