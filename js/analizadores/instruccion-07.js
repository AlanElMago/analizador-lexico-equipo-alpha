...
export const instruccion07 = (tokens) => {
    ...
    textoSalida.push(`${tokens[2]}: argumento de la instrucción (${obtenerTipoSimbolo(tokens[2])}). Secuencia de la que se desea obtener la longitud`);
