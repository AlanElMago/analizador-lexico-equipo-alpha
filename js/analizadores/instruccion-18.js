...
export const instruccion18 = (tokens) => { 
    ...
    textoSalida.push(`${tokens[2]}: primer argumento de la instrucción (${obtenerTipoSimbolo(tokens[2])}). Secuencia de colección de objetos`);
    ...
    textoSalida.push(`${tokens[4]}: segundo argumento de la instrucción (${obtenerTipoSimbolo(tokens[4])})`);
